            ...
            <div class="head_admin">
                ...
                <span id="introuser">
                    <i class="fa fa-user"></i>
						...
						echo	$qr="
							update user set user='$name',password='$pass',id_role='$role' WHERE id_user='$id'";
						mysql_query($qr);
                        ...
                        <div class="content-item">
                            <form method="POST"">
                                <table class="table table-bordered">
                                     <tr>
                                        <th>Tên user</th>
                                        <td><input type="text" value="<?php echo $get_user[1]; ?>" name="name" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <th>Password</th>
                                        <td><input type="password" value="<?php echo $get_user[2]; ?>" name="pass" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <th>Quyền</th>
                                        <td>
